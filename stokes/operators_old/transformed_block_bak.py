...
def compute_fem(problem, grid, boundary_info, mu, fem_order, write=False):
    g = grid
    bi = boundary_info
    ...
    if write:
        np.savetxt('/home/lucas/A_alt', a.todense())
        np.savetxt('/home/lucas/B_alt', -1.*b.todense())
        np.savetxt('/home/lucas/Bt_alt', b_t.T.todense())
        np.savetxt('/home/lucas/C_alt', c)
        np.savetxt('/home/lucas/F_alt', f)
...
def main():
    ...
    # get fem solution
    u_fem, v_fem, p_fem = compute_fem(problem, grid, boundary_info, mu_test, FEM_ORDER, True)
