...
class PoiseuilleLShapeProblem(StokesProblem):
    """
    ...
    def __init__(self, viscosity=1):
        ...
        domain = PolygonalDomain(points=[[0, 0], [1, 0], [2, 0], [2, 1], [2, 2], [1, 2], [1, 1], [0, 1]],
                                 boundary_types={BoundaryType('dirichlet'): [0, 1, 2, 3, 5, 6, 7],
                                                 BoundaryType('do_nothing'): [4]},
                                 holes=[],
                                 inner_edges=[[1, 6], [3, 6]],
                                 subdomains=[[0, 1, 6, 7], [1, 2, 3, 6], [3, 4, 5, 6]])
        ...
        super(PoiseuilleLShapeProblem, self).__init__(domain=domain, rhs=rhs, diffusion_functions=diffusion_functions,
